      ...
      tabItems(
        tabItem(
          ...
          fluidRow(
            ...
            box(
              width = 4,
              numericInput(inputId = "cutoff", label = "Remove Values Less Than",
                           50),
              textInput(
                inputId = "kinasefilter",
                label = "Remove Value from Just_Kinase Column",
                value = "Cascade"
              )
            )
          ),
          ...
          tabBox(
            ...
            tabPanel(
              ...
              downloadButton("downloadCleanedData",
                             "Download")
            ),
            tabPanel(
              "Filtered Data",
              withSpinner(dataTableOutput("cleanedfilteredtable"),
                          type = 2),
        ...
        tabItem(
          ...
          tabBox(
            ...
            tabPanel("Kinome Tree", div(id = "treediv"), div(id = "tooltip")),
            tabPanel(
              "Mutants",
              ...
              withSpinner(plotOutput("lolliplot"),
                          type = 2),
          ...
          box(
            width = 2,
            selectInput(
              inputId = "plotresultcolumn",
              label = "Result Column for Tree",
              choices = c("ratio", "bin_10", "bin_25"),
              selected = "bin_25",
              multiple = FALSE
            ),
            textInput(inputId = "charttitle", label = "Chart Title"),
            numericInput(
              inputId = "titlefontsize",
          ...
          box(
            ...
            colourInput("node_offtgt_cpick",
                        "", cpalette[2], showColour = "background"),
            colourInput("text_offtgt_cpick",
                        "Text-label", "#000000", showColour = "background")
          ),
          box(
            width = 12,
