...
writekinasetree <- function(svginfo,destination,font,labelselect,groupcolor,titley, titlefontsize)
{
  ...
  outputlines = c(outputlines,paste("<text x=\"425\" y=\"",titley,"\" text-anchor=\"middle\" font-weight=\"700\" font-family=\"", font,"\"  font-size=\"", titlefontsize, "\">",svginfo$title,"</text>",sep=""))
